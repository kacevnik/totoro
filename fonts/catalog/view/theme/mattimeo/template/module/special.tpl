...
<?php if ( (isset($position)) && ($position == 'column_left' || $position == 'column_right')){ ?> 
       ...
       <!--Carousel products--> 
         <section  class="list_carousel" id="special_scroll2">
         <div class="carou">
        <?php } ?> 
 ...
 <?php if ( (isset($position)) && ($position == 'column_left' || $position == 'column_right')){ ?> 
     ...
     <?php if (($this->config->get('showmore2_specials') == '1')  && ((isset($position)) && ($position == 'column_left' || $position == 'column_right')) )  { ?>  
     
          <?php if (isset($height_box))  { ?> 
		  <script type="text/javascript">    
		 $('#special_scroll2 .itemcolumns').css('min-height', <?php echo $height_box; ?>);
		 </script>
		 <?php } ?>        
         <script type="text/javascript"> 
		  $(document).ready(function(){
		$('#special_scroll2 .carou').carouFredSel({
			prev: '#special_scroll2 .prev',
			next: '#special_scroll2 .next',
			scroll: 1,
			swipe:{onTouch: true},
			auto: false,
			responsive: true,
      ...
      <?php } ?> 
       <?php if ($this->config->get('showmore_specials') == '1')  { ?>  
          ...
          <?php if (isset($height_box))  { ?> 
		  <script type="text/javascript">    
		 $('#special_scroll .itemcolumns').css('min-height', <?php echo $height_box; ?>);
		 </script>
		 <?php } ?>        
         <script type="text/javascript"> 
		  $(document).ready(function(){
