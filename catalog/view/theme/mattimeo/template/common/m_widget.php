...
<?php } ?>
    ...
    <?php if($this->config->get('odn_f_status') == '1'){?>
	<div id="box-odn" class="movebox">
     <!--VKONTAKTE-->
      <div class="icon-odn"></div>
	  <div class="content-move box">
		<h2 class="box-heading"><?php echo $this->config->get('odn_f_title'); ?></h2>
...
}(document,"ok_group_widget","<?php echo $this->config->get('odn_f_id')?>","{width:240,height:240}");
</script>  
