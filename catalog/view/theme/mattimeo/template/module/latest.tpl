...
<?php if ( (isset($position)) && ($position == 'column_left' || $position == 'column_right')){ ?> 
       ...
       <!--Carousel products--> 
         <section  class="list_carousel" id="latest_scroll2">
         <div class="carou">
        <?php } ?> 
 ...
 <?php if ( (isset($position)) && ($position == 'column_left' || $position == 'column_right')){ ?> 
     ...
     <?php if ($this->config->get('showmore_latest') == '1') { ?>  
		 ...
		 $('#latest_scroll .itemcolumns').css('min-height', <?php echo $height_box; ?>);
		 </script>
		 <?php } ?>        
         <script type="text/javascript"> 
     ...
     <?php } ?>
      <?php if (($this->config->get('showmore2_latest') == '1')  && ((isset($position)) && ($position == 'column_left' || $position == 'column_right')))  { ?>  
     
         <?php if (isset($height_box))  { ?> 
		  <script type="text/javascript">    
		 $('#latest_scroll2 .itemcolumns').css('min-height', <?php echo $height_box; ?>);
		 </script>
		 <?php } ?>        
         <script type="text/javascript"> 
		  $(document).ready(function(){
		$('#latest_scroll2 .carou').carouFredSel({
			prev: '#latest_scroll2 .prev',
			next: '#latest_scroll2 .next',
			scroll: 1,
			swipe:{onTouch: true},
			auto: false,
			responsive: true,
