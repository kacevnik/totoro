...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="checkout">
    ...
    <div id="shipping-address" class="nodisplay">
...
var text = $("#shipping-method > div").html();
	text = text.replace('3','4')
$("#shipping-method > div").html(text);
var text2 = $("#confirm > div").html();
	text2 = text2.replace('4','5')
$("#confirm > div").html(text2)
	<?php if(isset($quickconfirm)) { ?>
		quickConfirm();
	<?php }else{ ?>
		$.ajax({
