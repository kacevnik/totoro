  ...
  <div class="content">
    ...
    <div class="mini-cart-info">
      <table>
        ...
        <tr>
          <td class="image" rowspan="2"><?php if ($product['thumb']) { ?>
          ...
          <td class="total" rowspan="2"><?php echo $product['total']; ?></td>
          <td class="remove" rowspan="2"><img src="catalog/view/theme/mattimeo/image/remove-small.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" onclick="(getURLVar('route') == 'checkout/cart' || getURLVar('route') == 'checkout/checkout') ? location = 'index.php?route=checkout/cart&remove=<?php echo $product['key']; ?>' : $('#cart').load('index.php?route=module/cart&remove=<?php echo $product['key']; ?>' + ' #cart > *');" /></td>
        </tr>
        <tr> <td class="quantity">x&nbsp;<?php echo $product['quantity']; ?></td></tr>
        <?php } ?>
