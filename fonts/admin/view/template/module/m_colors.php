   ...
   <div class="span2"><?php echo $text_title_fonts; ?></div>
    ...
    <div class="row-fluid">
     <div class="span2"><?php echo $filterprice_text; ?></div>
					<div class="span10 colorfield">
                        Text: <input type="text"  name="filter_text" value="<?php echo $filter_text; ?>" class="color {required:false,hash:true}" >
						Background: <input type="text"  name="filter_color" value="<?php echo $filter_color; ?>" class="color {required:false,hash:true}" >
					</div>
	</div>
