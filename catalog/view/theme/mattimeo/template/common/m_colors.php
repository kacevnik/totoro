...
<?php if($this->config->get('filter_color')!='') { ?> 
   .irs-from, .irs-to, .irs-single{
	...
	.irs-from:after, .irs-to:after, .irs-single:after{
		border-top-color: <?php echo $this->config->get('filter_color') ?>;
		 } 	 	
<?php } ?> 
<?php if($this->config->get('filter_text')!='') { ?> 
   .irs-from, .irs-to, .irs-single{
		color: <?php echo $this->config->get('filter_text') ?>;
		 }	
<?php } ?>  
...
<?php if($this->config->get('product_name')!='') { ?> 
	...
	.wishlist-info tbody .name a, .review_name   {
...
<?php if($this->config->get('product_tabs_link')!='') { ?> 
	...
	.testimonials #filter > span:hover a, .testimonials #filter > span.active a,
	.sort  ul li .active a, .sort ul li a:hover, .limit  ul li a:hover{
