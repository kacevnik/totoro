						...
						<tbody>
							<tr>
								...
								<td>
                                    ...
                                    <label for="v_latest">
										<input id="v_latest" type="checkbox" value="1" name="settings[<?php echo $_name; ?>_v_latest]"<?php echo empty( $settings[$_name.'_v_latest'] ) ? '' : ' checked="checked"'; ?> /> <?php echo $text_latest; ?>
									</label>
									<br />
                                    <label for="v_special">
										<input id="v_special" type="checkbox" value="1" name="settings[<?php echo $_name; ?>_v_special]"<?php echo empty( $settings[$_name.'_v_special'] ) ? '' : ' checked="checked"'; ?> /> <?php echo $text_special ?>
									</label>
							...
							<tr>
								...
								<td>
                                    ...
                                    <label for="m_tabs">
										<input id="m_tabs" type="checkbox" value="1" name="settings[<?php echo $_name; ?>_m_tabs]"<?php echo empty( $settings[$_name.'_m_tabs'] ) ? '' : ' checked="checked"'; ?> /> <?php echo $text_tabs; ?>
									</label>
								</td>
							</tr>
						</tbody>
