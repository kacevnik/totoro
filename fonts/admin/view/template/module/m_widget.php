	...
	<div class="tabs-below tabbable" data-theme="tab_switch" id='custom-ft'>
		<ul class="nav nav-tabs">
            ...
            <li><a href="#tab_vk"><?php echo $footer_vk; ?></a>
             ...
             <li><a href="#tab_odn">Одноклассники</a>
				
				<?php 
					$valueq 	= $odn_f_status; $name = 'odn_f_status'; $id = 'odn_f_status';
				?>
				<span class="switch">
					<input type="checkbox" id="<?php echo $id; ?>" name="<?php echo $name; ?>" <?php if ($valueq) { ?>checked="checked"<?php }?> value="1">
					<label for="<?php echo $id; ?>" class="switch-img"></label>
            ...
            <div id="tab_vk" class="tab-pane">
				...
				<div class="control-group">
					...
					<div class="controls">
                      ...
                      <div id="tab_odn" class="tab-pane">
				
				<div class="control-group">
					<label class="control-label"><?php echo $footer_title; ?></label>
					<div class="controls">
						<input type="text" name="odn_f_title" value="<?php echo $odn_f_title; ?>">
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">Одноклассники id</label>
					<div class="controls">
						<input type="text" name="odn_f_id" value="<?php echo $odn_f_id; ?>">
					</div>
				</div>	
			</div>
