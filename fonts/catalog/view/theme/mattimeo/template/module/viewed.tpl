...
<?php if ( (isset($position)) && ($position == 'column_left' || $position == 'column_right')){ ?> 
       ...
       <?php if ($this->config->get('showmore2_viewed') == '1')  { ?>
       <!--Carousel products--> 
         <section  class="list_carousel" id="viewed_scroll2">
         <div class="carou">
        <?php } ?> 
 ...
 <?php } else { ?>
      ...
      <?php if ($this->config->get('showmore_viewed') == '1')  { ?>
       <!--Carousel products--> 
         <section  class="list_carousel content_carou" id="viewed_scroll">
         <div class="carou">
 ...
 <?php } ?>
    ...
    <?php if (($this->config->get('showmore2_viewed') == '1') && ((isset($position)) && ($position == 'column_left' || $position == 'column_right')))  { ?>   
         <?php if (isset($height_box))  { ?> 
		  <script type="text/javascript">    
		 $('#viewed_scroll2 .itemcolumns').css('min-height', <?php echo $height_box; ?>);
		 </script>
		 <?php } ?>       
         <script type="text/javascript"> 
		  $(document).ready(function(){
		   $('#viewed_scroll2 .carou').carouFredSel({
			prev: '#viewed_scroll2 .prev',
			next: '#viewed_scroll2 .next',
			scroll: 1,
			swipe:{onTouch: true},
			auto: false,
			responsive: true,
   ...
   <?php } ?> 
     <?php if ($this->config->get('showmore_viewed') == '1') { ?>   
        <?php if (isset($height_box))  { ?> 
		  <script type="text/javascript">    
		 $('#viewed_scroll .itemcolumns').css('min-height', <?php echo $height_box; ?>);
		 </script>
		 <?php } ?>  
         <script type="text/javascript"> 
		  $(document).ready(function(){
		   $('#viewed_scroll .carou').carouFredSel({
			prev: '#viewed_scroll .prev',
			next: '#viewed_scroll .next',
			scroll: 1,
			swipe:{onTouch: true},
			auto: false,
			responsive: true,
