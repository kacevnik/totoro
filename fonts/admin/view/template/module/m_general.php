...
<div class="row-fluid">
  ...
  <div class="row-fluid">
    ...
    <div class="row-fluid">
					<div class="span6"><?php echo $text_display_content; ?></div>
                    <div class="span6"><?php echo $text_display_column; ?></div>
    </div>
    <div class="row-fluid">                
					<div class="span6">
                    ...
                    <tr> <td><?php echo $text_latest; ?></td>
                     ...
                     <tr><td><?php echo $text_bestseller; ?></td>
                         <td><?php 
                    ...
                    <tr> <td><?php echo $text_specials; ?></td>
                         <td><?php 
                     ...
                     <tr> <td><?php echo $text_viewed; ?></td>
                         <td><?php 
						$ar 	= array( 'Default' =>0 , 'Carousel' =>1, ); $valueq 	= $showmore_viewed; $name	= 'showmore_viewed'; $id = 'showmore_viewed';
						?>
						<div class="btn-group" data-toggle="buttons-radio">
							<?php foreach ($ar as $key => $value) { ?>
								<?php ($value ==  $valueq) ? $selected = ' active' : $selected=''; ?>
                     ...
                     <tr><td><?php echo $text_related; ?></td>
                         <td><?php 
                      ...
                      <tr><td><?php echo $text_related2; ?></td>
                          <td> <?php 
						$ar 	= array( 'Default' =>0 , 'Carousel' =>1, ); $valueq 	= $showmore_related2; $name	= 'showmore_related2'; $id = 'showmore_related2';
						?>
						<div class="btn-group" data-toggle="buttons-radio">
							<?php foreach ($ar as $key => $value) { ?>
								<?php ($value ==  $valueq) ? $selected = ' active' : $selected=''; ?>
                      ...
                      <tr><td><?php echo $text_modtab; ?></td>
                          <td> <?php 
						$ar 	= array( 'Default' =>0 , 'Carousel' =>1, ); $valueq 	= $showmore_modtab; $name	= 'showmore_modtab'; $id = 'showmore_modtab';
						?>
						<div class="btn-group" data-toggle="buttons-radio">
							<?php foreach ($ar as $key => $value) { ?>
								<?php ($value ==  $valueq) ? $selected = ' active' : $selected=''; ?>
                      ...
                      <tr><td><?php echo $text_reviews ?></td>
                          <td> <?php 
						$ar 	= array( 'Default' =>0 , 'Carousel' =>1, ); $valueq 	= $showmore_reviews; $name	= 'showmore_reviews'; $id = 'showmore_reviews';
						?>
						<div class="btn-group" data-toggle="buttons-radio">
							<?php foreach ($ar as $key => $value) { ?>
								<?php ($value ==  $valueq) ? $selected = ' active' : $selected=''; ?>
                     ...
                     <tr><td><?php echo $text_shop ?></td>
                          <td> <?php 
						$ar 	= array( 'Default' =>0 , 'Carousel' =>1, ); $valueq 	= $showmore_shop; $name	= 'showmore_shop'; $id = 'showmore_shop';
						?>
						<div class="btn-group" data-toggle="buttons-radio">
							<?php foreach ($ar as $key => $value) { ?>
								<?php ($value ==  $valueq) ? $selected = ' active' : $selected=''; ?>
                      ...
                      <tr><td><?php echo $text_featuredwb ?></td>
                          <td> <?php 
						$ar 	= array( 'Default' =>0 , 'Carousel' =>1, ); $valueq = $showmore_featuredwb; $name	= 'showmore_featuredwb'; $id = 'showmore_featuredwb';
						?>
						<div class="btn-group" data-toggle="buttons-radio">
							<?php foreach ($ar as $key => $value) { ?>
								<?php ($value ==  $valueq) ? $selected = ' active' : $selected=''; ?>
					...
					<td><?php 
                     ...
                     <tr><td><?php echo $text_specials; ?></td>
                      ...
                      <tr> <td><?php echo $text_viewed; ?></td>
                         <td><?php 
						$ar 	= array( 'Default' =>0 , 'Carousel' =>1, ); $valueq 	= $showmore2_viewed; $name	= 'showmore2_viewed'; $id = 'showmore2_viewed';
						?>
						<div class="btn-group" data-toggle="buttons-radio">
							<?php foreach ($ar as $key => $value) { ?>
								<?php ($value ==  $valueq) ? $selected = ' active' : $selected=''; ?>
                     ...
                     <tr><td><?php echo $text_reviews ?></td>
                          <td> <?php 
						$ar 	= array( 'Default' =>0 , 'Carousel' =>1, ); $valueq 	= $showmore2_reviews; $name	= 'showmore2_reviews'; $id = 'showmore2_reviews';
						?>
						<div class="btn-group" data-toggle="buttons-radio">
							<?php foreach ($ar as $key => $value) { ?>
								<?php ($value ==  $valueq) ? $selected = ' active' : $selected=''; ?>
                     ...
                     <tr><td><?php echo $text_shop ?></td>
                          <td> <?php 
						$ar 	= array( 'Default' =>0 , 'Carousel' =>1, ); $valueq 	= $showmore2_shop; $name	= 'showmore2_shop'; $id = 'showmore2_shop';
						?>
						<div class="btn-group" data-toggle="buttons-radio">
							<?php foreach ($ar as $key => $value) { ?>
								<?php ($value ==  $valueq) ? $selected = ' active' : $selected=''; ?>
                      ...
                      <tr><td><?php echo $text_featuredwb ?></td>
                          <td> <?php 
						$ar 	= array( 'Default' =>0 , 'Carousel' =>1, ); $valueq = $showmore2_featuredwb; $name	= 'showmore2_featuredwb'; $id = 'showmore2_featuredwb';
						?>
						<div class="btn-group" data-toggle="buttons-radio">
							<?php foreach ($ar as $key => $value) { ?>
								<?php ($value ==  $valueq) ? $selected = ' active' : $selected=''; ?>
