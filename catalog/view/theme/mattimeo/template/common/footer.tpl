...
VK.Widgets.Group("vk_groups", {mode: <?php echo $vk_mode; ?>, width: "300", height: "400"}, <?php echo $vk_id; ?>);
</script>
</div>
...
<script type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter40168015 = new Ya.Metrika({
                    id:40168015,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/40168015" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
</div>
</body></html>