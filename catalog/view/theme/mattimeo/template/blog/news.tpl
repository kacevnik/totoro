...
<div id="content" class="blog_ocshop">
  ...
  <div class="product-list">
    ...
    <div  class="item">
      ...
      <i class="fa fa-eye"></i> <?php echo $text_views; ?> <?php echo $article["viewed"];?>&nbsp;&nbsp;</div>
      <div class="description"><?php echo $article['description']; ?></div>
	  <div class="more"><a class="readmore" href="<?php echo $article['href']; ?>"><?php echo $button_more; ?></a></div>
...
function display(view) {
	if (view == 'list') {
		...
		$('.display').html('<span class="iconlist"></span> <a onclick="displaybutton(\'grid\');" class="icongrid"></a>');
		...
		$('.display').html('<a onclick="displaybutton(\'list\');" class="iconlist"></a> <span class="icongrid"></span>');
