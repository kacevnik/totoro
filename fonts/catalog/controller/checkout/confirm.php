...
class ControllerCheckoutConfirm extends Controller { 
	public function index() {
		...
		if (!$redirect) {
			...
			$data['payment_address_1'] = 'ул. '.$payment_address['street'];
			$data['payment_address_1'] .= ', дом: '.$payment_address['dom'];
			if($payment_address['pod']){$data['payment_address_1'] .= ', подъезд: '.$payment_address['pod'];}
			if($payment_address['eta']){$data['payment_address_1'] .= ', этаж: '.$payment_address['eta'];}
			if($payment_address['kva']){$data['payment_address_1'] .= ', квартира: '.$payment_address['kva'];}
