...
class ControllerModuleMattimeoTheme extends Controller {
	...
	public function index() {   
		...
		$this->data['text_featuredwb'] = $this->language->get('text_featuredwb');
		...
		$this->data['text_related2'] = $this->language->get('text_related2');
		$this->data['text_viewed'] = $this->language->get('text_viewed');
		$this->data['text_modtab'] = $this->language->get('text_modtab');
		...
		$this->data['link_abuses'] = $this->language->get('link_abuses');
		$this->data['link_testimonial'] = $this->language->get('link_testimonial');
